						...
						<c:forEach var="i" items="${datas}">
							<tr>
								<td class="align-middle"><input type="checkbox"
									class="check" value="${datas.indexOf(i)}" name="check"></td>
				...
				<div class="col-sm-6 border fs-4">
					<ul class="list-group list-group-flush">
						<li class="list-group-item"><span>상품 가격</span> <strong
							class="price_sum"><c:set var="total" value="0" /> <c:forEach var="result" items="${datas}" varStatus="status">
						...
						<li class="list-group-item"><a href="cartBuy.do"
							class="btn btn-outline-primary fs-5">구매하기</a> <a href="main.do"
							class="btn btn-outline-primary fs-5">쇼핑 더하기</a></li>
					</ul>
				</div>
