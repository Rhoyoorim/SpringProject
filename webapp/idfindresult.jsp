		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center pt-5">
					<c:if test="${member[0].mid!=null}">
						<p class="lead mb-5">아이디를 성공적으로 찾았습니다.</p>
						<p class="lead mb-5">회원님이 보유한 아이디 목록입니다.</p>
								
								<c:forEach var="v" items="${member}">
									<p class="lead mb-5">${v.mid}</p>
								</c:forEach>
						<p class="mb-5">
							<a href="login.jsp" class="btn btn-outline-primary">로그인하러 가기</a>
						</p>
					</c:if>
					<c:if test="${member[0].mid==null}">
